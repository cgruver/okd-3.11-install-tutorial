...
# Network information
#network  --bootproto=static --ip=10.10.11.66 --netmask=255.255.255.0 --gateway=10.10.11.1 --nameserver=10.10.11.50 --device=eth0 --ipv6=auto --activate 
#network  --hostname=oscappnode04.oscluster.clgcom.org
...
part pv.157 --fstype="lvmpv" --ondisk=sda --size=19455 --grow --maxsize=200000
...
logvol /var/lib/mysql  --fstype="xfs" --grow --maxsize=1000000 --size=1024 --name=dbfs --vgname=dbvg
