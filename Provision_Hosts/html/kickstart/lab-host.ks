...
network  --bootproto=static --device=${NIC_02} --ip=${IP_02} --netmask=${NETMASK_02} --noipv6 --activate --onboot=yes
network  --hostname=${HOST_NAME}
fi
...
curl -o /root/firstboot.sh %%INSTALL_URL%%/firstboot/${ROLE_FILE}.fb
